...
# 检查MTProxy新版本
check_New_ver(){
    New_ver=$(curl -s https://api.github.com/repos/fireinrain/MTProxyTLS/releases/latest | grep -oP '"tag_name": "\K([^"]+)')
...
Download(){
    ...
    check_Arch
    wget --no-check-certificate https://github.com/fireinrain/MTProxyTLS/releases/download/${New_ver}/MTProxy-${New_ver}-linux-${Arch}.tar.gz
